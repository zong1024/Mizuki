...
export const siteConfig: SiteConfig = {
	title: "zong1024 的博客",
	subtitle: "记录项目、折腾与日常想法",
	siteURL: "http://202.60.232.93:8080/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-04-08", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	banner: {
		...
		homeText: {
			...
			subtitle: [
				"这里会慢慢记录项目、折腾和一些有意思的想法",
				"先把喜欢做的事情留下来，再慢慢把它们讲清楚",
				"关于树莓派、工具、开发和日常实验的长期整理",
				"新站还在完善中，但已经可以开始写下第一篇文章了",
				"欢迎偶尔回来看看这里又多了些什么",
			],
			typewriter: {
